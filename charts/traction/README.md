...
| `ui.ux.aboutBusiness.title`                        | The title for the About page business section                                                                                                                                                                                                              | `DigiCred Holdings`               |
| `ui.ux.aboutBusiness.linkTitle`                    | The description for the About page business section link                                                                                                                                                                                                   | `BC DigiCred Holdings`           |
| `ui.ux.aboutBusiness.link`                         | The URL for the About page business section link                                                                                                                                                                                                           | `https://github.com/bcgov/bc-vcpedia/`         |
| `ui.ux.aboutBusiness.imageUrl`                     | The image in the About page business section                                                                                                                                                                                                               | `/img/digicred/digicred.png`                          |
